...
function updateCashierRecords(data, next) {
	var today = new Date();
...
router.post("/cashierSendMoney", jwtTokenAuth, async function (req, res) {
	try {
