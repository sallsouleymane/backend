...
router.post("/partnerCashier/interBank/sendToOperational", JWTTokenAuth, function (req, res) {
                                        ...
                                        Collection.findOne(
                                            ...
                                            (err, toBranch) => {
                                                if (err) {
                                                    ...
                                                    Bank.findOne({ _id: toBranch.bank_id }, (err, toBank) => {
                                                        if (err) {
                                                            console.log(err);
                                                            var message = err;
                                                            if (err.message) {
                                                                                    ...
                                                                                    if (err) {
                                                                                        ...
                                                                                        Fee.findOne(find, function (err, rule2) {
                                                                                            if (err) {
                                                                                                ...
                                                                                                interBankSendMoneyToWallet(transfer,
                                                                                                    infra,
                                                                                                    bank,
                                                                                                    receiverBank,
                                                                                                    branch,
