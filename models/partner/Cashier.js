...
const PartnerCashierSchema = new mongoose.Schema({
    ...
    cash_paid_fee: { type: Number, required: false, default: 0 },
	cash_paid_commission: { type: Number, required: false, default: 0 },
	cash_received_fee: { type: Number, required: false, default: 0 },
	cash_received_commission: { type: Number, required: false, default: 0 },
...
module.exports = mongoose.model("PartnerCashier", PartnerCashierSchema);
